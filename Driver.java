...
public class Driver {
    ...
    private static void explore(Egypt egypt) throws Exception {
        System.out.println("\nEgyptians have three terrains to explore: \n"
            + "1. Desert\n"
            + "2. Hills\n"
            + "3. The " + egypt.getRiver().getName() + " River\n");
        ...
        if (move == 1) {
            ...
            gameplayHills(egypt.getHills(), egypt.getPopulation(),
                egypt.getTreasury(), egypt.getCoalMine());
        } else if (move == 3) {
    ...
    private static void gameplayHills(Hills hills, Population population,
        ...
        if (move == 1) {
            ...
            coalMine.increasePotential(coalFound);
    ...
    private static void build(RomanEmpire rome, Settlement settlement) {
        ...
        if (buildMove == 1) {
            ...
            print += rome.buildBaths(settlement) ? "You've built a bath house!"
                : "You need enough workers AND gold to build this structure.";
        } else if (buildMove == 3) {
